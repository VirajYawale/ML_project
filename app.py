...
# Enter the applicant’s details below to find out if their loan is likely to be **approved or rejected**.
# """)
# st.divider()

# # ------------------------------------------------------------
# # 🎛️ Sidebar Information
# # ------------------------------------------------------------
# with st.sidebar:
#     st.header("📘 About the App")
#     st.write("""
#     This app uses a **Machine Learning (XGBoost)** model trained on loan applicant data.  
#     It predicts whether a loan will be approved based on financial and demographic details.
#     """)
#     st.info("💡 Tip: Higher income, good credit history, and semi-urban property areas increase approval chances.")
...
# # Combine all inputs into DataFrame
# input_data = {
...
#                 st.markdown("""
#                 💡 **Insight:**  
#                 Your loan is likely approved based on strong repayment potential and credit history.
#                 """)
#             else:
...
#                 - Income too low for requested loan amount  
#                 - Property area or dependent count may reduce eligibility
#                 """)
...
#             st.info("Please make sure your input format matches the model training structure.")

# # ------------------------------------------------------------
# # 💡 Insights Section
# # ------------------------------------------------------------
# st.divider()
# st.subheader("📊 Data Insights & Tips")
# st.markdown("""
# ✅ **Approval Factors:**  
# - Applicants with **good credit history (1.0)** are far more likely to get approval.  
# - **Semiurban areas** have higher approval rates due to economic stability.  
# - A **balanced income-to-loan ratio** improves creditworthiness.  
# - Applicants with **fewer dependents** show higher repayment ability.  

# 📘 **Pro Tip:**  
# Try adjusting your income or loan amount to see how it affects your result — it’s an interactive learning tool too!
# """)
